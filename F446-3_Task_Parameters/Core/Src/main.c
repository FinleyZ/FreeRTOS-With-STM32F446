...
int main(void)
{
  ...
  xTaskCreate(vOrangeLedTask,"OrangeLedTask",128,NULL,1,NULL);
  vTaskStartScheduler();
...
static void MX_GPIO_Init(void)
{
  ...
  /*Enable the clock access to GPIO D port*/
  __HAL_RCC_GPIOD_CLK_ENABLE();

  /*Configure GPIO pin Output Level */
  //or HAL_GPIO_WritePin (GPIOD, GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15, GPIO_PIN RESET) ;
